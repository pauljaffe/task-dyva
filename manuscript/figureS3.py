...
class FigureS3:
    ...
    def __init__(self, model_dir, save_dir, metadata, rand_seed, n_boot):
        ...
        self.acc_stats = {
            n: copy.deepcopy(self.stats_dict) for n in self.noise_labels
        }
    ...
    def _run_preprocessing(self):
        for expt_str, ab, uid, sc, exg, early, opt in zip(
            ...
            var_path = os.path.join(
                self.model_dir, expt_str, self.analysis_dir, self.outputs_fn
            )
            ...
            inter_rts, inter_acc = self._get_interaction_stats(
                var_expt_stats, expt_str
            )
    ...
    def _get_interaction_stats(self, data, expt_str):
        # Stay RTs
        u_rt_stay_con_inds = data.select(
            **{
                "is_switch": 0,
                "ucorrect": 1,
                "u_prev_correct": 1,
        ...
        m_rt_stay_con_inds = data.select(
            **{
                "is_switch": 0,
                "mcorrect": 1,
                "m_prev_correct": 1,
        ...
        u_rt_stay_incon_inds = data.select(
            **{
                "is_switch": 0,
                "ucorrect": 1,
                "u_prev_correct": 1,
        ...
        m_rt_stay_incon_inds = data.select(
            **{
                "is_switch": 0,
                "mcorrect": 1,
                "m_prev_correct": 1,
        ...
        # Switch RTs
        u_rt_switch_con_inds = data.select(
            **{
                "is_switch": 1,
                "ucorrect": 1,
                "u_prev_correct": 1,
        ...
        m_rt_switch_con_inds = data.select(
            **{
                "is_switch": 1,
                "mcorrect": 1,
                "m_prev_correct": 1,
        ...
        u_rt_switch_incon_inds = data.select(
            **{
                "is_switch": 1,
                "ucorrect": 1,
                "u_prev_correct": 1,
        ...
        m_rt_switch_incon_inds = data.select(
            **{
                "is_switch": 1,
                "mcorrect": 1,
                "m_prev_correct": 1,
        ...
        # Stay accuracy
        u_acc_stay_con_correct_inds = data.select(
            **{
                "is_switch": 0,
                "ucorrect": 1,
                "u_prev_correct": 1,
        ...
        u_acc_stay_con_incorrect_inds = data.select(
            **{
                "is_switch": 0,
                "ucorrect": 0,
                "u_prev_correct": 1,
        ...
        u_acc_stay_con = self._get_condition_acc(
            u_acc_stay_con_correct_inds, u_acc_stay_con_incorrect_inds, data.df
        )
        m_acc_stay_con_correct_inds = data.select(
            **{
                "is_switch": 0,
                "mcorrect": 1,
                "m_prev_correct": 1,
        ...
        m_acc_stay_con_incorrect_inds = data.select(
            **{
                "is_switch": 0,
                "mcorrect": 0,
                "m_prev_correct": 1,
        ...
        m_acc_stay_con = self._get_condition_acc(
            m_acc_stay_con_correct_inds, m_acc_stay_con_incorrect_inds, data.df
        )
        u_acc_stay_incon_correct_inds = data.select(
            **{
                "is_switch": 0,
                "ucorrect": 1,
                "u_prev_correct": 1,
        ...
        u_acc_stay_incon_incorrect_inds = data.select(
            **{
                "is_switch": 0,
                "ucorrect": 0,
                "u_prev_correct": 1,
        ...
        u_acc_stay_incon = self._get_condition_acc(
            u_acc_stay_incon_correct_inds,
            u_acc_stay_incon_incorrect_inds,
            data.df,
        )
        m_acc_stay_incon_correct_inds = data.select(
            **{
                "is_switch": 0,
                "mcorrect": 1,
                "m_prev_correct": 1,
        ...
        m_acc_stay_incon_incorrect_inds = data.select(
            **{
                "is_switch": 0,
                "mcorrect": 0,
                "m_prev_correct": 1,
        ...
        m_acc_stay_incon = self._get_condition_acc(
            m_acc_stay_incon_correct_inds,
            m_acc_stay_incon_incorrect_inds,
            data.df,
        )
        # Switch accuracy
        u_acc_switch_con_correct_inds = data.select(
            **{
                "is_switch": 1,
                "ucorrect": 1,
                "u_prev_correct": 1,
        ...
        u_acc_switch_con_incorrect_inds = data.select(
            **{
                "is_switch": 1,
                "ucorrect": 0,
                "u_prev_correct": 1,
        ...
        u_acc_switch_con = self._get_condition_acc(
            u_acc_switch_con_correct_inds,
            u_acc_switch_con_incorrect_inds,
            data.df,
        )
        m_acc_switch_con_correct_inds = data.select(
            **{
                "is_switch": 1,
                "mcorrect": 1,
                "m_prev_correct": 1,
        ...
        m_acc_switch_con_incorrect_inds = data.select(
            **{
                "is_switch": 1,
                "mcorrect": 0,
                "m_prev_correct": 1,
        ...
        m_acc_switch_con = self._get_condition_acc(
            m_acc_switch_con_correct_inds,
            m_acc_switch_con_incorrect_inds,
            data.df,
        )
        u_acc_switch_incon_correct_inds = data.select(
            **{
                "is_switch": 1,
                "ucorrect": 1,
                "u_prev_correct": 1,
        ...
        u_acc_switch_incon_incorrect_inds = data.select(
            **{
                "is_switch": 1,
                "ucorrect": 0,
                "u_prev_correct": 1,
        ...
        u_acc_switch_incon = self._get_condition_acc(
            u_acc_switch_incon_correct_inds,
            u_acc_switch_incon_incorrect_inds,
            data.df,
        )
        m_acc_switch_incon_correct_inds = data.select(
            **{
                "is_switch": 1,
                "mcorrect": 1,
                "m_prev_correct": 1,
        ...
        m_acc_switch_incon_incorrect_inds = data.select(
            **{
                "is_switch": 1,
                "mcorrect": 0,
                "m_prev_correct": 1,
        ...
        m_acc_switch_incon = self._get_condition_acc(
            m_acc_switch_incon_correct_inds,
    ...
    def _plot_figure_get_stats(self):
        ...
        F_params = {"ylabel": "Mean RT (ms)", "plot_legend": True}
        ...
        G_params = {"ylabel": "Accuracy", "plot_legend": True}
